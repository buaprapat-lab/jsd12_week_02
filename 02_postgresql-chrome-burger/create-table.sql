...
CREATE TABLE Ingredients (ingredient_id SERIAL PRIMARY KEY,
...
CREATE TABLE MenuItems (item_id SERIAL PRIMARY KEY,
                                       name VARCHAR(255) NOT NULL UNIQUE,
...
CREATE TABLE RecipeItems (recipe_item_id SERIAL PRIMARY KEY,
...
CREATE TABLE OrderItems (order_item_id SERIAL PRIMARY KEY,
